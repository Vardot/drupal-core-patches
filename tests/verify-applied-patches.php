...
/**
 * @file
 * Verifies that composer-patches applied every core patch it could.
 *
...
if ($patches === []) {
    echo "No patches declared on this branch (forward-compat placeholder); nothing to apply.\n";
    exit(0);
}
...
echo "\nPASS — composer-patches applied every declared patch on every installed package.\n";
